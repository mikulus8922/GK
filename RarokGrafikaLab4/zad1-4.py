...
def render(time):
    ...
    if viewing_mode == 0:
        ...
        if phi > 90:
            ...
            phi = -90
        xeye = scale * numpy.cos(theta * (numpy.pi/180)) * numpy.cos(phi * (numpy.pi/180))
        yeye = scale * numpy.sin(phi * (numpy.pi/180))
        zeye = scale * numpy.sin(theta * (numpy.pi/180)) * numpy.cos(phi * (numpy.pi/180))
